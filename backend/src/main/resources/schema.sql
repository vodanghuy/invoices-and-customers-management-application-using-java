--/*
--* --- General Rules ---
--* Use underscore_names instead of CamalCase
...
(
    ...
    img_url      VARCHAR(255) DEFAULT 'https://cdn-icons-png.flaticon.com/128/3059/3059518.png',
...
(
    ...
    permissions  VARCHAR(255) NOT NULL, -- user:read, user:delete, customer:read, customer:delete
